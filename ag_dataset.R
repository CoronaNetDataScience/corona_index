...
saveRDS(index_long, paste0("/scratch/coronanet/index_long_disag_",type,".rds"))
write_csv(index_long,paste0("/scratch/coronanet/index_long_disag_",type,".csv"))
zip(paste0("/scratch/coronanet/index_long_disag_",type,".zip"),
    paste0("/scratch/coronanet/index_long_disag_",type,".csv"))
...
saveRDS(index_long_model,paste0("/scratch/coronanet/index_long_model_",type,".rds"))
...
saveRDS(index_long_var,paste0("/scratch/coronanet/wide_data_binary_",type,".rds"))

saveRDS(index_long_pop,paste0("/scratch/coronanet/wide_data_pop_weighted_",type,".rds"))
